...
public class GraphicsCreator {
    ...
    public static void showGraphic(LineChart<Number, Number> lineChart, Complex[] values, String title) {
    ...
    public static void showGraphicRe(LineChart<Number, Number> lineChart, Complex[] values, String title) {
        lineChart.setTitle(title);
        lineChart.setLegendVisible(false);
        XYChart.Series series = new XYChart.Series();
    ...
    public static void showGraphicIm(LineChart<Number, Number> lineChart, Complex[] values, String title) {
        lineChart.setTitle(title);
        lineChart.setLegendVisible(false);
        XYChart.Series series = new XYChart.Series();
